  ...
  return (
    <>
      ...
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 flex items-center justify-between px-6 md:px-8 lg:px-10 py-3 bg-white rounded-full shadow-lg z-50 w-[95%] max-w-6xl border border-gray-200 transition-all">
        ...
        <div className="hidden sm:flex items-center gap-6">
          ...
          {!user ? (
            ...
            <div className='relative user-menu'>
              ...
              {showUserMenu && (
                <ul className='absolute top-12 right-0 bg-white shadow-lg border border-gray-200 py-2 w-40 rounded-xl text-sm z-40'>
                  <li 
                    onClick={() => {
                      navigate("my-orders");
                      setOpen(false);
        ...
        {open && (
          <div className="absolute top-14 right-4 bg-white shadow-xl py-3 flex-col items-start gap-1 px-4 text-sm rounded-xl z-20 w-48">
            <NavLink 
              to="/" 
